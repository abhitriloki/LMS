...
return [
    ...
    */
    ...
    | with your search engines are queued. When this is enabled, all automatic
    | data syncing will get queued for better performance.
    |
    */
    ...
    */
    ...
    | if your application still needs to search for the records.
    |
    */
    ...
    | engine supports any analytics based on this application.
    |
    */
