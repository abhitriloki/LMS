    ...
    <div class="card hover:shadow-lg transition-shadow duration-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900 dark:text-white mt-1"><?php echo e(number_format($stats['totalUsers'])); ?></p>
            </div>
    ...
    <div class="card hover:shadow-lg transition-shadow duration-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900 dark:text-white mt-1"><?php echo e(number_format($stats['totalCourses'])); ?></p>
                <p class="text-xs text-gray-500 dark:text-gray-500 mt-1"><?php echo e($stats['publishedCourses']); ?> published</p>
            </div>
    ...
    <div class="card hover:shadow-lg transition-shadow duration-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900 dark:text-white mt-1"><?php echo e(number_format($stats['activeEnrollments'])); ?></p>
                <p class="text-xs text-gray-500 dark:text-gray-500 mt-1"><?php echo e($stats['completedEnrollments']); ?> completed</p>
            </div>
    ...
    <div class="card hover:shadow-lg transition-shadow duration-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900 dark:text-white mt-1"><?php echo e($stats['averageCompletionRate']); ?>%</p>
                <p class="text-xs text-gray-500 dark:text-gray-500 mt-1"><?php echo e($stats['totalCertificates']); ?> certificates</p>
            </div>
        ...
        <div class="space-y-3">
            <?php $__empty_1 = true; $__currentLoopData = $topCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div class="flex-1">
                        <p class="font-medium text-gray-900 dark:text-white"><?php echo e($course->title); ?></p>
                        <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($course->enrollments_count); ?> enrollments</p>
                    </div>
                    <a href="<?php echo e(route('admin.courses.show', $course)); ?>" class="text-primary-600 hover:text-primary-700 dark:text-primary-400">
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                <?php $__empty_1 = true; $__currentLoopData = $departmentStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white"><?php echo e($dept->name); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400"><?php echo e($dept->user_count); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400"><?php echo e($dept->enrollment_count); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">
                            <div class="flex items-center">
                                <div class="w-16 bg-gray-200 dark:bg-gray-700 rounded-full h-2 mr-2">
                                    <div class="bg-primary-600 h-2 rounded-full" style="width: <?php echo e($dept->avg_progress ?? 0); ?>%"></div>
                                </div>
                                <span><?php echo e(number_format($dept->avg_progress ?? 0, 1)); ?>%</span>
                            </div>
                        </td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $recentActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="flex items-start space-x-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <div class="flex-shrink-0">
                    <?php if($activity->user && $activity->user->avatar): ?>
                        <img src="<?php echo e(Storage::url($activity->user->avatar)); ?>" alt="<?php echo e($activity->user->name); ?>" class="w-10 h-10 rounded-full">
                    <?php else: ?>
                        <div class="w-10 h-10 rounded-full bg-primary-100 dark:bg-primary-900 flex items-center justify-center">
                            <span class="text-primary-600 dark:text-primary-400 font-semibold"><?php echo e(substr($activity->user->name ?? 'U', 0, 1)); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="flex-1 min-w-0">
                    <p class="text-sm text-gray-900 dark:text-white">
                        <span class="font-medium"><?php echo e($activity->user->name ?? 'User'); ?></span>
                        <?php echo e($activity->event_type); ?>

                        <?php if($activity->course): ?>
                            <span class="font-medium"><?php echo e($activity->course->title); ?></span>
                        <?php endif; ?>
                    </p>
                    <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($activity->created_at->diffForHumans()); ?></p>
                </div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (ctx) {
        const data = <?php echo json_encode($enrollmentTrends, 15, 512) ?>;
        new Chart(ctx, {
            type: 'line',
            data: {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\wamp64\www\corporate-lms\resources\views/dashboard/admin.blade.php ENDPATH**/ ?>