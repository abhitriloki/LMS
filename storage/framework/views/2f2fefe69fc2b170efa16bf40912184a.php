...
<head>
    ...
    <title><?php echo e(config('app.name', 'Corporate LMS')); ?> - <?php echo $__env->yieldContent('title'); ?></title>
        ...
        <div class="mb-6">
            <a href="/">
                <h1 class="text-3xl font-bold text-primary-600 dark:text-primary-400">
                    <?php echo e(config('app.name', 'Corporate LMS')); ?>
...
<?php /**PATH C:\wamp64\www\corporate-lms\resources\views/layouts/guest.blade.php ENDPATH**/ ?>